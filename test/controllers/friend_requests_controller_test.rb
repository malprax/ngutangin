...
class FriendRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend_request" do
    assert_difference('FriendRequest.count') do
      post friend_requests_url, params: { friend_request: { email: @friend_request.email, phone: @friend_request.phone, request_token: @friend_request.request_token, status: @friend_request.status, user_id: @friend_request.user_id } }
    end
  ...
  test "should update friend_request" do
    patch friend_request_url(@friend_request), params: { friend_request: { email: @friend_request.email, phone: @friend_request.phone, request_token: @friend_request.request_token, status: @friend_request.status, user_id: @friend_request.user_id } }
